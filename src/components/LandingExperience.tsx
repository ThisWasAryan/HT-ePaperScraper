  ...
  return (
    <div className="landing-container">
      <div className="landing-hero">
        <h1 className="landing-title serif">HT-ePaperScraper</h1>
        <p className="landing-subtitle">
          Browse, read, and download current and historical Hindustan Times ePaper editions in high resolution.
        </p>
      </div>
